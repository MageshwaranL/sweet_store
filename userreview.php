            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
                ...
                <div>
                    <div class="rounded-lg border p-4">
                        ...
                        <a href="#"
                            class="block rounded-lg border bg-white px-4 py-2 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:px-8 md:py-3 md:text-base">Write
                            a review</a>
                    </div>
                </div>
                <!-- overview - end -->
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="border-t pt-6">
                        <a href="#"
                            class="flex items-center gap-0.5 font-semibold text-indigo-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Read
                            all reviews</a>
                    </div>
                </div>
                <!-- reviews - end -->
