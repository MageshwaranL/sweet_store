...
<div style="text-align: center;">
    <img  src="https://sweet.newtheme.shop/images/sweet_logo.png" alt="" style="max-width: 40%; height:auto; margin-left: 130px !important">
            ...
            <h1 class="mt-3 text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white text-center">sign Up</h1>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 text-center ">
                    <a href="/Auth/login.php" class="text-sm text-blue-500 hover:underline dark:text-blue-400">
